...
<nav class="nav">
    <div class="container">
        ...
        <div id="mainListDiv" class="main_list">
            <ul class="btn">
                <li><a href="#CONTACTS"><button class="btn default">Info</button></a></li>
...
<div style="height: 100%">
            ...
            <div style = "position:relative; left:33.3%; top:-50px;">
               <p class="myP"><img class="img2"; src="logo.jpg" alt="Avatar"></p>
            </div>
        ...
        <div class="flex-container">
            ...
            <div class="flex-child magenta" height="1000px">
                ...
                <p class="myP"style = "position:relative; left:2%; top:20px;"><img class="img3_logo" src="twitter.png" alt="Avatar"><a href="https://twitter.com/tiket2" aligh="center"> &nbsp&nbsp Twitter</a></p> 
                <p class="myP"style = "position:relative; right:0%; top:20px;"><img class="img4_logo" src="facebook.png" alt="Avatar"><a href="https://www.facebook.com/eskyglobal/" aligh="center"> Facebook</a></p> 
                <p class="myP"style = "position:relative; left:1.7%; top:20px;"><img class="img5_logo" src="instagram.jfif" alt="Avatar"><a href="https://www.instagram.com/esky_travel/" aligh="center"> &nbsp&nbsp Instagram</a></p> 
                <p class="myP"style = "position:relative; left:0.4%; top:20px;"><img class="img7_logo" src="youtube-logo.png" alt="Avatar"><a href="https://www.youtube.com/eSkyTravel" aligh="center">  YouTube</a></p> 
        <br><br>
